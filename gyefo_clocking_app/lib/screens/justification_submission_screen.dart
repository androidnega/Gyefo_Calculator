...
class JustificationSubmissionScreen extends StatefulWidget {
  ...
  @override
  State<JustificationSubmissionScreen> createState() => _JustificationSubmissionScreenState();
}

class _JustificationSubmissionScreenState extends State<JustificationSubmissionScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow('Date', DateFormat('MMM dd, yyyy').format(record.clockIn)),
                    _buildDetailRow('Clock-in', DateFormat('HH:mm').format(record.clockIn)),
                    if (record.clockOut != null)
                      _buildDetailRow('Clock-out', DateFormat('HH:mm').format(record.clockOut!)),
                    if (record.actualDuration != null)
                      _buildDetailRow('Work Duration', record.workDurationFormatted),
                    if (record.isLate)
                    ...
                    const SizedBox(height: 12),
                    const Text('Issues Detected:', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            if (_selectedReason == 'Other (please specify)' || _selectedReason == null)
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Additional details:', style: TextStyle(fontWeight: FontWeight.w500)),
                  const SizedBox(height: 8),
                  TextField(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _isLoading || _reasonController.text.trim().isEmpty
                    ? null
