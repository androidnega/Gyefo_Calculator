                      ...
                      child: events.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final clockInTime = DateFormat('HH:mm:ss').format(attendance.clockIn);
                                final clockOutTime = attendance.clockOut != null
                                    ? DateFormat('HH:mm:ss').format(attendance.clockOut!)
                                    : 'Not clocked out';
                                        ...
                                        Row(
                                          children: [
                                            Container(
                                              ...
                                              child: Text(
                                                attendance.clockOut != null ? 'Completed' : 'In Progress',
                                                style: TextStyle(
                                                  fontSize: 12,
                                                  color: statusColor,
                                                  fontWeight: FontWeight.w500,
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: _buildTimeInfo(
                                                ...
                                                label: 'Clock Out',
                                                time: clockOutTime,
                                                color: attendance.clockOut != null ? Colors.red : Colors.grey,
                                              ),
                                            ),
                                          ],
                                        ),
                ...
                Card(
                  ...
                  child: TableCalendar<AttendanceModel>(
                    ...
                    calendarStyle: CalendarStyle(
                      ...
                      holidayTextStyle: TextStyle(color: Colors.red.shade700, fontWeight: FontWeight.bold),
                      markersMaxCount: 3,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: _buildStatItem(
                                        ...
                                        value: '${_attendanceMap.values.fold(0, (total, list) => total + list.length)}',
                                  ...
                                  children: [
                                    Expanded(
                                      child: _buildStatItem(
                                        ...
                                        value: '${_holidayMap.values.fold(0, (total, list) => total + list.length)}',
