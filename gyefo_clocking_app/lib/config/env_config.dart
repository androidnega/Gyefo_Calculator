...
class EnvConfig {
  ...
  static String get firebaseApiKeyAndroid => _getEnvVar('FIREBASE_API_KEY_ANDROID');
  ...
  static String get firebaseAppIdAndroid => _getEnvVar('FIREBASE_APP_ID_ANDROID');
  ...
  static String get googleMapsApiKey => _getEnvVar('GOOGLE_MAPS_API_KEY', fallback: '');
  static String get stripePublishableKey => _getEnvVar('STRIPE_PUBLISHABLE_KEY', fallback: '');
  
  // Database Configuration
  static String get databaseUrl => _getEnvVar('DATABASE_URL', fallback: '');
  
  // Third-party Service Keys
  static String get pushNotificationKey => _getEnvVar('PUSH_NOTIFICATION_KEY', fallback: '');
  ...
  static String _getEnvVar(String key, {String fallback = ''}) {
    ...
    const envVars = <String, String>{
      // Firebase Web
      'FIREBASE_API_KEY_WEB': String.fromEnvironment('FIREBASE_API_KEY_WEB', defaultValue: ''),
      'FIREBASE_APP_ID_WEB': String.fromEnvironment('FIREBASE_APP_ID_WEB', defaultValue: ''),
      
      // Firebase Android
      'FIREBASE_API_KEY_ANDROID': String.fromEnvironment('FIREBASE_API_KEY_ANDROID', defaultValue: ''),
      'FIREBASE_APP_ID_ANDROID': String.fromEnvironment('FIREBASE_APP_ID_ANDROID', defaultValue: ''),
      
      // Firebase iOS
      'FIREBASE_API_KEY_IOS': String.fromEnvironment('FIREBASE_API_KEY_IOS', defaultValue: ''),
      'FIREBASE_APP_ID_IOS': String.fromEnvironment('FIREBASE_APP_ID_IOS', defaultValue: ''),
      ...
      'FIREBASE_STORAGE_BUCKET': String.fromEnvironment('FIREBASE_STORAGE_BUCKET', defaultValue: ''),
      'FIREBASE_AUTH_DOMAIN': String.fromEnvironment('FIREBASE_AUTH_DOMAIN', defaultValue: ''),
      ...
      'PUSH_NOTIFICATION_KEY': String.fromEnvironment('PUSH_NOTIFICATION_KEY', defaultValue: ''),
    };
  ...
  static bool validateConfig() {
    ...
    if (firebaseApiKeyAndroid.isEmpty) missingKeys.add('FIREBASE_API_KEY_ANDROID');
    if (firebaseApiKeyIos.isEmpty) missingKeys.add('FIREBASE_API_KEY_IOS');
    
    if (missingKeys.isNotEmpty) {
      debugPrint('Missing critical environment variables: ${missingKeys.join(', ')}');
      return false;
    }
